...
class _RateScreenState extends State<RateScreen> {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: const Icon(Icons.check_circle, color: Color(0xFF552219), size: 60),
          content: const Column(
            ...
            children: [
              ...
              Text(
                ...
                textAlign: TextAlign.center,
                style: TextStyle(color: Color(0xFF552219), fontSize: 16),
              ),
            ],
          ),
          actions: [
            Center(
              child: ElevatedButton(
                ...
                child: const Padding(
                  ...
                  child: Text("العودة للرئيسية", style: TextStyle(fontWeight: FontWeight.bold)),
                ),
              ),
            )
          ],
  ...
  Widget _buildRatingCard({required int questionIndex, required String question}) {
    return Container(
            ...
            child: Column(
              ...
              children: List.generate(ratingOptions.length, (optionIndex) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedScale(
                    scale: isSelected ? 1.05 : 1.0, // تكبير بنسبة 5% إذا تم اختياره
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(
                            ...
                            color: const Color(0xFF185A80), // لون الدائرة الأزرق
                            size: 24,
                          ),
                          ...
                          AnimatedDefaultTextStyle(
                            duration: const Duration(milliseconds: 200),
                            style: TextStyle(
                              color: isSelected ? const Color(0xFF30100A) : const Color(0xFF552219),
